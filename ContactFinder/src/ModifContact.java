...
public class ModifContact extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModifContact frame = new ModifContact();
	...
	public ModifContact() {
		...
		Ville.setText("Pessac");
		Ville.setBounds(406, 344, 200, 25);
		contentPane.add(Ville);
		Ville.setColumns(10);
		
		Email = new JTextField();
		Email.setText("mybrainisout@gmail.com");
		...
		btnModifier.setBounds(250, 525, 100, 25);
		...
		JLabel lblTitre = new JLabel("Modifier Contact");
